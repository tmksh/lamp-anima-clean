      ...
      <div className="flex flex-col items-start gap-10 md:gap-[60px] relative self-stretch w-full flex-[0_0_auto]">
        <div className="flex flex-col items-start gap-5 relative self-stretch w-full flex-[0_0_auto]">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-[120px] items-start pl-0 md:pl-5 pr-0 py-0 relative w-full">
            <div className="relative w-fit mt-[-1.00px] [font-family:'Shippori_Mincho',Helvetica] font-semibold text-[#dec17a] text-xl md:text-2xl tracking-[0] leading-[40.8px] whitespace-nowrap">
              実施概要
            </div>
