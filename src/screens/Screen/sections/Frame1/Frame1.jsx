    ...
    <div className="flex flex-col w-full items-center gap-12 md:gap-20 pt-12 md:pt-20 pb-16 md:pb-[120px] px-4 md:px-8 relative flex-[0_0_auto]">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-6 pl-0 pr-0 md:pr-[30px] py-0 relative flex-1 w-full min-w-0">
              ...
              <div className="flex flex-col items-center gap-2.5 relative flex-[0_0_auto] w-full md:w-auto">
                <div className="inline-flex flex-col items-center relative flex-[0_0_auto]">
                  ...
                  <img
                    className="relative w-[20px] md:w-[30.31px] h-auto -mt-2"
                    alt="Polygon"
                    src="/img/polygon-4.svg"
                  />
                </div>
      ...
      <div className="relative w-full max-w-[1000px] h-auto aspect-video">
        <video 
          ...
          preload="metadata"
        >
          <source src="/img/4人指導.mp4#t=0.1" type="video/mp4" />
          お使いのブラウザは動画タグをサポートしていません。
        </video>
      </div>

      {/* 金額セクション */}
      <div className="flex flex-col items-center gap-8 relative w-full max-w-[1000px] flex-[0_0_auto] py-12 md:py-16 px-4 md:px-8 bg-gradient-to-br from-[#fef3f9] via-[#fef0f5] to-[#f9eff9] rounded-2xl border-4 border-double border-[#d2a3cb] shadow-2xl">
        <div className="flex flex-col items-center gap-4 relative w-full">
          <div className="relative w-fit [font-family:'Allura',Helvetica] font-normal text-[#d2a3cb] text-4xl md:text-5xl tracking-[0] leading-[normal]">
            Course Fee
          </div>
          
          <div className="relative w-fit [font-family:'Shippori_Mincho',Helvetica] font-bold text-[#d2a3cb] text-2xl md:text-3xl tracking-[2px] leading-[normal]">
            受講料金
          </div>
        </div>
